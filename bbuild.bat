...
%cl_path%\cl.exe /nologo ..\src\%project_name%.c ..\src\display.c ..\src\salloc.c ..\src\vector.c /DEBUG:FULL /Z7 /I%vcpkg_path%\include user32.lib gdi32.lib %vcpkg_path%\lib\SDL2.lib

rem add dynamic lib with exe
XCOPY %vcpkg_path%\bin\SDL2.dll .
